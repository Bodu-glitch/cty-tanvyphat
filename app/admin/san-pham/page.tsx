...
import LogoutButton from '../don-hang/LogoutButton'
      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-4 flex-wrap">
            <h1 className="font-bold text-gray-900">🛍️ Quản lý sản phẩm</h1>
            <Link href="/admin/don-hang" className="text-sm text-gray-500 hover:text-gray-700">Đơn hàng</Link>
            <Link href="/admin/tin-tuc" className="text-sm text-gray-500 hover:text-gray-700">Tin tức</Link>
          </div>
          <div className="flex items-center gap-3">
            <Link
              href="/admin/san-pham/tao-moi"
              className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-1.5 rounded-lg transition-colors whitespace-nowrap"
            >
              + Thêm sản phẩm
            </Link>
            <LogoutButton />
