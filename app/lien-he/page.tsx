      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-gradient-to-br from-[#1a3a6b] to-[#1a56db] rounded-2xl p-6 text-white">
              ...
              <div className="flex flex-col gap-3">
                <a
                  href={`tel:${store.phone}`}
                  className="flex items-center gap-3 bg-amber-500 hover:bg-amber-400 text-white font-semibold px-4 py-3 rounded-xl transition-colors text-sm"
                >
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-5 border-b border-gray-100">
            <h2 className="text-lg font-bold text-[#1a3a6b]">Bản đồ – Khu vực Q.12, TPHCM</h2>
